...
train_file_name = "dataset_IDS2017_1M_8.csv"
test_file_name = "dataset_IDS2017_1M_9.csv"
result_name = "RF_IDS_5"
...
def loadDataset():
    ...
    with open("../dataset/IDS/" + train_file_name, "r") as csvfile:
    ...
    with open("../dataset/IDS/" + test_file_name, "r") as csvfile:
        reader = csv.reader(csvfile, delimiter=',')
...
def train_random_forest(training_data, testing_data):
    ...
    x_actual_test_input = testing_data[:, 0:-1]
    ...
    return y_actual_test_label, pred_testing_set, testing_acc
