...
def separate_training_testing(normalized, num_training, num_testing):
    ...
    with open("../dataset/UNSW/Preprocessed_UNSW_NB15_training-set.csv", "w") as csvWriter:
        writer = csv.writer(csvWriter)

        for i in range(len(training_set)):
            writer.writerow(training_set[i])

    with open("../dataset/UNSW/Preprocessed_UNSW_NB15_testing-set.csv", "w") as csvWriter:
        writer = csv.writer(csvWriter)
