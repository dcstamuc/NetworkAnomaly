...
def test():
    ...
    with open("../dataset/IDS/dataset_partial_IDS2017_1M_0.csv", "r") as csv_reader:
...
def write_dataset(features, labels):
    ...
    for i in range(len(dataset_list)):
        with open("../dataset/IDS/dataset_partial_" + file_name + "_" + str(i) + ".csv", "w") as csvWriter:
