...
train_file_name = "UNSW_NB15_testing-set_full_x_attack_cat.csv"
test_file_name = "UNSW_NB15_training-set_full_x_attack_cat.csv"
result_name = "RF_Full_NB15"
...
def loadDataset():
    ...
    with open("../dataset/UNSW_Full_RandomForest/" + test_file_name, "r") as csvfile:
    ...
    with open("../dataset/UNSW_Full_RandomForest/" + train_file_name, "r") as csvfile:
        reader = csv.reader(csvfile, delimiter=',')
