...
def generating(encoded, label):
    ...
    for i in range(len(encoded)):
        ...
        if not os.path.exists("../results/UNSW_Grey/" + image_dir):
            os.mkdir("../results/UNSW_Grey/" + image_dir)
            print(image_dir + " directory is created")

        if not os.path.exists("../results/UNSW_Grey/" + image_dir + "/malicious"):
            os.mkdir("../results/UNSW_Grey/" + image_dir + "/malicious")
            print(image_dir + "/malicious " + " directory is created")

        if not os.path.exists("../results/UNSW_Grey/" + image_dir + "/normal"):
            os.mkdir("../results/UNSW_Grey/" + image_dir + "/normal")
            print(image_dir + "/normal " + " directory is created")

        if label[i] == '1':
            cv2.imwrite("../results/UNSW_Grey/" + image_dir + "/malicious" + "/record" + str(i) + ".jpg", data)
        elif label[i] == '0':
            cv2.imwrite("../results/UNSW_Grey/" + image_dir + "/normal" + "/record" + str(i) + ".jpg", data)
