...
def loadResultSet(step):
    ...
    malicious_list = []
    with open("../dataset/" + dirName + "/" + sub_name + "/" + file_name + str(step) + "_malicious_result.csv", "r") as csvfile:
    ...
    normal_total_list = []
    normal_list = []
    with open("../dataset/" + dirName + "/" + sub_name + "/" + file_name + str(step) + "_normal_result.csv", "r") as csvfile:
        reader = csv.reader(csvfile, delimiter=',')
...
if __name__ == "__main__":
    for i in range(1, 10):
        malicious_total_cnt, malicious_total_list, malicious_list, normal_total_cnt, normal_total_list, normal_list, step = loadResultSet(i)
