...
dirName = "NSLKDD"
sub_dirName = "train-plus"
file_name = "NSLKDD_train-plus_test-minus"
...
def loadResultSet():
    ...
    malicious_list = []
    with open("../dataset/" + dirName + "/" + sub_dirName + "/" + file_name + "_malicious_result.csv", "r") as csvfile:
    ...
    normal_total_list = []
    normal_list = []
    with open("../dataset/" + dirName + "/" + sub_dirName + "/" + file_name + "_normal_result.csv", "r") as csvfile:
        reader = csv.reader(csvfile, delimiter=',')
